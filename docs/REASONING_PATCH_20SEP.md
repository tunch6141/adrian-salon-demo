...
- Business context is retrieved before narration and review, including each selected staff member. Context-only questions can be answered without a dummy SQL query. Notes remain owner-reported and cannot change calculated results.
